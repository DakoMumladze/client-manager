    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-[45%] bg-stone-900 flex-col justify-between p-12">
        ...
        <div>
          <blockquote className="mb-8">
            <p className="text-2xl font-medium text-white leading-snug">
              &ldquo;Everything I need to stay on top of my clients — finally in
              one place.&rdquo;
            </p>
        ...
        <p className="text-muted-foreground text-xs">
          © 2026 Client Manager. All rights reserved.
        </p>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12">
        <Link
          href="/"
          className="mb-10 text-lg font-semibold text-foreground tracking-tight lg:hidden"
        >
          Client Manager
        </Link>
        ...
        <div className="w-full max-w-[360px]">
          ...
          <p className="mt-8 text-center text-xs leading-relaxed text-muted-foreground">
            ...
            and <span className="underline cursor-default">Privacy Policy</span>
            .
          </p>
        </div>
      </div>
